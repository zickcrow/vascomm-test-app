            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex items-center flex-shrink-0">
                                <inertia-link :href="dashboardRoute">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="dashboardRoute" :active="currentRoute">
                                    Dashboard
                                </jet-nav-link>
                                
                                <jet-nav-link :href="route('admin.users.index')" :active="route().current('admin.users.index')">
                                    Users
                                </jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :href="dashboardRoute" :active="currentRoute">
                            Dashboard
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :href="route('admin.users.index')" :active="route().current('admin.users.index')">
                            Users
                        </jet-responsive-nav-link>
                    </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            dashboardRoute() {
                return this.$page.props.user.is_admin ? route('admin.dashboard') : route('user.dashboard')
            },

            currentRoute() {
                return this.$page.props.user.is_admin ? route().current('admin.dashboard') : route().current('user.dashboard')
            }
        },
